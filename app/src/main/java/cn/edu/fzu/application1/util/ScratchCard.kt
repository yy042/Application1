...
class ScratchCard(context: Context, attrs: AttributeSet) :
    View(context, attrs) {
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        mSrcResult = Bitmap.createScaledBitmap(mSrcResult!!, bitmapWidth, bitmapHeight, true) // 将图片缩放到指定大小
        mSrcBitmap = Bitmap.createScaledBitmap(mSrcBitmap!!, bitmapWidth, bitmapHeight, true) // 将图片缩放到指定大小
