...
class ScratchLayout @JvmOverloads constructor(
    context: Context,
    ...
    // 增加一个ImageView来显示“开始刮”的图片
    private lateinit var mStartImage: ImageView
    ...
    init {
        ...
        // 初始化ImageView并设置图片资源和点击事件
        mStartImage = binding.btnScratch
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        mSrcResult =
            BitmapFactory.decodeResource(resources, R.drawable.pic_scratch_win)
        mSrcBitmap =
            BitmapFactory.decodeResource(resources, R.drawable.layer_scratch_front)

        //根据View宽度和原图宽高比计算要绘制的图片尺寸
        val ratio =
            mSrcBitmap.height.toFloat() / mSrcBitmap.width.toFloat() //不转换为Float的话ratio会是0
        ...
        mSrcBitmap = Bitmap.createScaledBitmap(
            mSrcBitmap!!,
            bitmapWidth,
            bitmapHeight,
            true
